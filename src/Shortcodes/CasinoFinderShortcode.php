...
final class CasinoFinderShortcode
{
    ...
    private function buildMarkup(array $atts): string
    {
        ...
        <div class="casino-finder-wizard" id="casino-finder-wizard">
            ...
            <div class="casino-finder-wizard__toolbar" id="casino-finder-toolbar" style="display:none;">
            ...
            <div class="casino-finder-wizard__back-wrap" id="casino-finder-back-wrap" style="display:none;">
            </div>

            <div class="casino-finder-wizard__body" id="casino-finder-body">
                <?php foreach ($steps as $index => $step) : ?>
                    <div
                        class="casino-finder-step"
            ...
            <div class="casino-finder-wizard__results" id="casino-finder-results" style="display:none;"></div>
            <div class="casino-finder-wizard__load-more" id="casino-finder-load-more-wrap" style="display:none;">
